                    ...
                    <div className='flex-1 flex items-center justify-center sm:items-stretch sm:justify-start'>
                        ...
                        <div className='hidden sm:flex sm:ml-12'>
                            <div className='flex items-center justify-center space-x-4'>
                                ...
                                >
                                    <TbTruckDelivery className='h-5 w-5 inline-block mr-1' /> Orders
                                </Link>
                                <Link href='/rider/chat-with-user'
                                    className='text-blue-600 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium
                                    flex justify-center
                                    '
                                >
                                    <AiOutlineMessage className='h-5 w-5 inline-block mr-1' /> Chat with Customer
                                </Link>
                            </div>
                        </div>
                    </div>
